...
export function startThirdGame(
  pageLeftSide: any,
  pageRightSide: any,
  nickName: string,
  ...
  var extendTimeAfterNofWords = 5;
  var heartIcoWidth: number = 50;
