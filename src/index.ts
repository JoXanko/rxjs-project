...
var FGdesc: string =
  "1. Prilikom startovanja prve igre timer odmah počinje da odbrojava, tako da budite spremni. Potrebno je pronaći ključ na ekranu. Da biste to uspeli potrebno je koristiti krugove sa leve strane, koji pomeranjem miša pokazuju vašu udaljenost od ključa. Kada mu se dovoljno približite ključ će postati vidljiv, a potom je potrebno kliknuti na njega, čime će se timer pauzirati, katacan otključati i pokrenuti druga igra.";
var SGdesc: string =
  "2. U drugoj igri je potrebno pamtiti reči koje se prikazuju na ekranu. Za svaku reč imate 2.5 sekunde da odgovorite da li je ona već viđena ili nova. Kada utvrdite potrebno je kliknuti na dugme i time će se rezultat za tu igru povećati ili ostati nepromenjen ukoliko ste pogrešili. Biće vam prikazane 12 reči";
var TGdesc: string =
...
var warning: string =
  'Klikom na dugme "Pokreni" počeće prva igra, tako da budite spremni!';
...
firstGameDesc.innerHTML = FGdesc;
...
secondGameDesc.innerHTML = SGdesc;
...
nickNameInput.addEventListener("keydown", function (e) {
  if (e.key === "Enter") startGamesButton.click();
});
